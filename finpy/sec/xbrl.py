...
class XBRL:
    ...
    def GetBaseInformation(self):        
        ...
        oNode = self.getNode('//us-gaap:CommonStockSharesOutstanding[@contextRef]')
        if oNode is not None:
            self.fields['CommonStockSharesOutstanding'] = float(oNode.text)
        else:
            self.fields['CommonStockSharesOutstanding'] = "CommonStockSharesOutstanding not found"
